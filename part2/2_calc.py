...
class Ui_Form(object):
    ...
    def dodawanie(self):
        liczba1 = float(self.lineEdit.text())
        liczba2 = float(self.lineEdit_2.text())
    ...
    def odejmowanie(self):
        ...
        liczba2 = float(self.lineEdit_2.text())
        suma = liczba1 - liczba2
        self.label_3.setText('Odejmowanie : {}'.format(suma))

    def mnozenie(self):
        liczba1 = float(self.lineEdit.text())
        liczba2 = float(self.lineEdit_2.text())
        suma = liczba1 * liczba2
        self.label_3.setText('Mnożenie : {}'.format(suma))

    def dzielenie(self):
        liczba1 = float(self.lineEdit.text())
        liczba2 = float(self.lineEdit_2.text())
        suma = liczba1 / liczba2
        self.label_3.setText('Dzielenie : {}'.format(suma))
